...
const AddMedications = ({ id }) => {
  ...
  textForSpeech +=
    "Enter the dosage of the medication the patient needs to take, no measurement required, ";
  ...
  textForSpeech +=
    "Finally, enter the date that the patient begins taking the medication";
  ...
  const addAppointmentHandler = (event) => {
    ...
    if (
      ...
      window.alert(
        "You must select at least one day to take the prescribed medications"
      );
      return false;
    }
            ...
            <div>
              ...
              <div>
                ...
                <input
                  ...
                  value="Tuesday"
                  checked={tuesdaySelected === "Tuesday"}
                  type="radio"
                ></input>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  value="Wednesday"
                  checked={wednesdaySelected === "Wednesday"}
                  type="radio"
                ></input>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  value="Thursday"
                  checked={thursdaySelected === "Thursday"}
                  type="radio"
                ></input>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  checked={saturdaySelected === "Saturday"}
                  type="radio"
                ></input>
              </div>
